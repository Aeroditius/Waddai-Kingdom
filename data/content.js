                    ...
                    <div class="gallery-container">
                        <div class="gallery-grid">
                            <div class="gallery-item" data-image="images/img_1_1748690905993.jpg">
                                <img src="images/img_1_1748690905993.jpg" alt="Kingdom of Wadai Heritage" loading="lazy">
                                <div class="gallery-caption">
                                    <h3><i class="fas fa-crown"></i> Kingdom of Wadai Heritage</h3>
                            ...
                            <div class="gallery-item" data-image="images/img_2_1748690929995.jpg">
                                ...
                                <div class="gallery-caption">
                                    ...
                                    <p>Authentic way of life in Wadai</p>
                                </div>
                            </div>
                            <div class="gallery-item" data-image="images/img_3_1748690940840.jpg">
                                ...
                                <div class="gallery-caption">
                                    ...
                                    <p>Natural beauty of the Wadai region</p>
                                </div>
                            </div>
                            ...
                            <div class="gallery-item" data-image="images/img_8_1748691019000.jpg">
                                ...
                                <div class="gallery-caption">
                                    ...
                                    <p>Ancient landmarks and monuments in Wadai</p>
                                </div>
                            </div>
                            <div class="gallery-item" data-image="images/albert-sukhanov-sB6e1jw9bBQ-unsplash.jpg">
                                <img src="images/albert-sukhanov-sB6e1jw9bBQ-unsplash.jpg" alt="Kingdom of Wadai" loading="lazy">
                                <div class="gallery-caption">
                                    <h3><i class="fas fa-crown"></i> Kingdom of Wadai</h3>
                            ...
                            <div class="gallery-item" data-image="images/hhh.jpg">
                                ...
                                <div class="gallery-caption">
                                    ...
                                    <p>Spectacular natural landscapes of Wadai</p>
                                </div>
                            </div>
    ...
    en: {
        ...
        sections: {
            mission: {
                ...
                content: "To preserve and promote the rich heritage and history of the Kingdom of Wadai for future generations."
            },
            vision: {
                title: '<i class="fas fa-eye"></i> Our Vision',
                content: "To be the primary source of knowledge about the history and culture of the Kingdom of Wadai."
            },
            goals: {
                            ...
                            <div class="col">
                                <div class="card h-100 goal-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Documenting and preserving the cultural and historical heritage of the Kingdom of Wadai through systematic research and recording.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 goal-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Spreading awareness about the history and culture of the Kingdom of Wadai through educational programs and heritage workshops.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 goal-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Building partnerships with academic institutions and cultural organizations internationally to enhance understanding of Wadai's heritage on a global scale.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                ...
                content: `
                    <div class="history-overview mb-4">
                        <div class="alert alert-info">
                            ...
                            <p>The Kingdom of Wadai (or Ouaddaï) was founded around 1635 CE by Sultan Abd al-Karim and flourished for over three centuries as one of the most important Islamic kingdoms in Central Africa, located in what is now eastern Chad.</p>
                        </div>
                    </div>
                    ...
                    <div class="historical-timeline mt-5">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                <div class="timeline-date">1635</div>
                                <div class="timeline-content">Foundation of Wadai Kingdom by Sultan Abd al-Karim</div>
                            </div>
                            <div class="timeline-item">
                                <div class="timeline-date">1681</div>
                            ...
                            <div class="timeline-item">
                                <div class="timeline-date">1912</div>
                                <div class="timeline-content">Fall of the last Sultan of Wadai and end of independent rule</div>
                            </div>
                        </div>
                    </div>
                `
                                ...
                                <a href="#places" class="text-decoration-none">
                                    <div class="card h-100 space-card">
                                        <div class="card-body text-center">
                                            ...
                                            <p class="card-text">Geographical locations and specific landmarks in the Kingdom of Wadai</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            <div class="col">
                                <div class="card h-100 space-card">
                                    <div class="card-body text-center">
                                        <i class="fas fa-mountain fa-3x mb-3 text-success"></i>
                                        <h5 class="card-title">Eastern Wadai Mountains</h5>
                            ...
                            <div class="col">
                                <div class="card h-100 space-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">The main lifeline of the Wadai region, providing water for agriculture and drinking. The region is intersected by fertile valleys that support agricultural and pastoral life, forming the basic ecosystem.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
            ...
            language: {
                ...
                content: `
                    <p>The primary language of Wadai is Maba, belonging to the Nilo-Saharan language family. Chadian Arabic is widely used as a trade and communication language. Multiple dialects exist, including Masalit and Tama variants. Arabic script was traditionally used for official and religious documents.</p>
                            ...
                            <div class="col">
                                <div class="card h-100 politics-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Wadai's political system was characterized by hereditary monarchy, with sultans ruling with the help of an advisory council. Notable rulers included Sultan Abd al-Karim Sabun and Sultan Muhammad Sharif. The kingdom maintained important alliances with neighboring sultanates.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 ancient-trade-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Wadai's economy was based on trans-Saharan trade, particularly with Egypt and Sudan. The kingdom was an important center for ivory, feather, and leather trade. Various currencies were used for trade, including cowrie shells and metal coins.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 education-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Wadai's education system includes traditional Quranic schools and modern education. It focuses on learning the Quran and Arabic language, along with basic crafts and trade skills.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 transformation-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Wadai communities have experienced gradual development in social structure while preserving core traditions and values. Lifestyle patterns and social relationships have evolved over time.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 women-youth-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Women play an important role in Wadai society, especially in trade and handicrafts. Youth represent the driving force for development and preservation of cultural heritage.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            publications: {
                ...
                content: `<p>A diverse collection of publications about the Kingdom of Wadai:</p>
                <ul>
                            ...
                            <div class="video-item">
                                <div class="video-container">
                                    ...
                                    <div class="video-overlay">
                                        ...
                                        <p class="video-description">Educational content about Kingdom of Wadai</p>
                                </div>
                                </div>
                            </div>
                            <div class="video-item">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            <div class="col">
                                <div class="card h-100 ancient-card">
                                    <div class="card-body text-center">
                                        <i class="fas fa-palace fa-3x mb-3 text-danger"></i>
                                        <h5 class="card-title">Kingdom of Wadai</h5>
                                        <p class="card-text">The great Kingdom of Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 ancient-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Ancient kingdom that preceded Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Exploring ancient historical periods in the Wadai region</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Unique landscapes and environment of Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Traditional and contemporary performing arts of the Kingdom of Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Social practices, rituals and festive events in Wadai heritage</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Knowledge and practices concerning nature and universe in the Kingdom of Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
        ...
        footer: "© 2025 Kingdom of Wadai - All rights reserved",
        store: {
            title: "Bookstore",
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            <div class="col">
                                <div class="card h-100 ancient-card">
                                    <div class="card-body text-center">
                                        <i class="fas fa-palace fa-3x mb-3 text-danger"></i>
                                        <h5 class="card-title">Royaume de Wadai</h5>
                                        <p class="card-text">Le grand Royaume de Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100 ancient-card">
                                    <div class="card-body text-center">
                                        <i class="fas fa-crown fa-3x mb-3 text-warning"></i>
                                        <h5 class="card-title">Tunjur-Dajo</h5>
                                        <p class="card-text">Royaume ancien qui précède Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card h-100 heritage-card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Paysages uniques et environnementaux de Wadai</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
